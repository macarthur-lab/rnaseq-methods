...
SMTSD_TO_TISSUE_NAME = {
    TISSUE_NAME_TO_SMTSD[tissue]: tissue for tissue in TISSUE_NAME_TO_SMTSD
}
...
#metadata_df = metadata_df[
#    metadata_df["analysis batch"].isin(["whole_blood", "lymphocytes", "fibroblasts", "muscle"])]

print(f"Filtered to {len(metadata_df)} columns")
