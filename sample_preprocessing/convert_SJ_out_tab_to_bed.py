...
p = argparse.ArgumentParser(description="This script takes a STAR splice junction file (*.SJ.out.tab) and converts it to a .bed.gz file (with .tbi index) which can be loaded into IGV.js."
